...
export const manifests = table("manifests", {
  ...
  assignedTo: int("assigned_to").references(() => trucks?.id), //? Forign Key for relation between truck and manifests, one truck can have multiple assigned manifests or none at all.
});
